...
CREATE TABLE IF NOT EXISTS PECI_PROJ.SysUser(
    ...
    NIF				VARBINARY(255) 	NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS PECI_PROJ.ProgressLog(
    ...
    PRIMARY KEY(progClientID, progDataID)
);
...
ALTER TABLE PECI_PROJ.ProgressLog
ADD CONSTRAINT FK_progressLog_programID
FOREIGN KEY (progDataID) REFERENCES PECI_PROJ.Program(programID) ON DELETE CASCADE;
